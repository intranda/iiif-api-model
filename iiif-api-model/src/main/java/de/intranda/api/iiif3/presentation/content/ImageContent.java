 ...
 */
package de.intranda.api.iiif3.presentation.content;
...
import de.intranda.api.iiif3.image.ImageInformation3;
import de.intranda.api.iiif3.presentation.enums.DcType;
import de.intranda.api.iiif3.presentation.enums.Format;
...
public class ImageContent implements IContent {
    ...
    private ImageInformation3 service;
    ...
    public ImageContent(URI id, ImageInformation3 service) {
        this.id = id;
     ...
     * @return the service
     */
    public ImageInformation3 getService() {
        return service;
    }
    ...
    public void setService(ImageInformation3 service) {
        this.service = service;
    }
